...
const i18nFacade = {
	...
	$tMetaDisplayName(m: {id: string, defaultDisplayName?: string, componentName?: string, behaviourName?: string }) {
...
export function useI18n() { return inject(I18N_FACADE_INJECTION_KEY)!; }
