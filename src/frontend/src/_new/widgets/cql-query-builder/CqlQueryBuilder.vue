...
import type { CqlQueryBuilderData, CqlQueryBuilderOptions, CqlTokenData } from '@/_new/widgets/cql-query-builder/model';
import { COMPARATORS, OPERATORS } from '@/_new/widgets/cql-query-builder/model';
