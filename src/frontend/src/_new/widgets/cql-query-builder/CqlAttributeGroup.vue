...
import uid from '@/_new/shared/utils/useUid';
import type { CqlAnnotationCombinator, CqlAttributeData, CqlAttributeGroupData, CqlGroupEntry, CqlQueryBuilderOptions } from '@/_new/widgets/cql-query-builder/model';
import { isCqlAttributeData, isCqlAttributeGroupData } from '@/_new/widgets/cql-query-builder/model';
