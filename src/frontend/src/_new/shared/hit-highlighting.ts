...
import type { CaptureAndRelation, TokenHighlight } from '@/_new/types/apptypes';
import type { BLHit, BLHitInOtherField, BLHitResults, BLMatchInfo, BLMatchInfoList, BLMatchInfoRelation, BLMatchInfoSpan, BLSearchSummaryPattern } from '@/_new/types/blacklabtypes';
// TODO this is a bit dirty, make it a function argument if possible
import type { UnionHelpers } from '@/_new/types/helpers';
