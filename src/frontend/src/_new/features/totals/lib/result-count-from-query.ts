...
import { getTotals, type TotalsOutput } from '@/_new/features/totals/lib/result-count-helpers';
...
import { InteractiveLoadable, mapLoaded } from '@/_new/shared/utils/loadable/loadable-streams';
