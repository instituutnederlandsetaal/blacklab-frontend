...
import type { ModuleRootState as ExploreModuleRootState } from '@/_new/pages/search/form/store/explore-state';
import type { ModuleRootState as PatternModuleRootState } from '@/_new/pages/search/form/store/pattern-store';
