...
import { getValueFunctions } from '@/_new/pages/search/form/filters/lib/filterValueFunctions';
import type { ModuleRootState as ModuleRootStateFilters } from '@/_new/pages/search/form/filters/store/filter-store';
import type { ModuleRootState as ModuleRootStateExplore } from '@/_new/pages/search/form/store/explore-state';
import type { ModuleRootState as ModuleRootStatePatterns } from '@/_new/pages/search/form/store/pattern-store';
import type * as AppTypes from '@/_new/types/apptypes';
import { CqlGenerator } from '@/_new/widgets/cql-query-builder/model';

import { applyWithinClauses, parenQueryPartParallel } from '@/_new/shared/blacklab-helpers/cql/bcql-pattern-helpers';
import { getCorrectUiType, uiTypeSupport } from '@/_new/shared/blacklab-helpers/normalize-responses';
import { getParallelFieldParts } from '@/_new/shared/blacklab-helpers/parallel-helper';
import { elementAndAttributeNameFromFilterId } from '@/_new/shared/blacklab-helpers/span-filters-helper';
import { escapeRegex, splitIntoTerms, type RegexEscapeOptions } from '@/_new/shared/utils/string-utils';
