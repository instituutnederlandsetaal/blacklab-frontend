...
import { IterativeResultCountLoader } from '@/_new/pages/search/results/totals/lib/result-count-from-query';
import type { TotalsOutput } from '@/_new/pages/search/results/totals/lib/result-count-helpers';
