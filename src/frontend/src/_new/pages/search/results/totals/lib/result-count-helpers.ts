...
import type { FilteredResultCountLoaderOutput } from '@/_new/pages/search/results/totals/lib/result-count-from-filters';
import type { NormalizedIndex } from '@/_new/types/apptypes';
import { hasGroupInfo, hasPatternInfo, type BLSearchResult, type BLSearchSummary } from '@/_new/types/blacklabtypes';
...
export function getCorpusTotals(index: NormalizedIndex, annotatedFieldId: string): FilteredResultCountLoaderOutput {
	return {
