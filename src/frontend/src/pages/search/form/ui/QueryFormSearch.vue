...
import * as InterfaceStore from '@/pages/search/form/store/interface-state';
import * as PatternStore from '@/pages/search/form/store/pattern-store';
import { getPatternStringFromCql } from '@/pages/search/form/utils/pattern-utils';
...
import ParallelSourceAndTargets from '@/pages/search/form/parallel/ParallelSourceAndTargets.vue';
