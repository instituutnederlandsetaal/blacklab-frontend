...
import type { ModuleRootState as ExploreModuleRootState } from '@/pages/search/form/store/explore-state';
import type { ModuleRootState as PatternModuleRootState } from '@/pages/search/form/store/pattern-store';
