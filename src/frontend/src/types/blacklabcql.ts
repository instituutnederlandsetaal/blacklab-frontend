...
export type PositionFilterOperation =
    | "containing"
    | "containing_at_start"
    | "containing_at_end"
    | "within"
...
export type BCQLRootRelationTargetNode =
    BCQLRegularRelationTargetNode & {
        direction: "root";
    };

export type BCQLRelationTargetNode =
    | BCQLRegularRelationTargetNode
    | BCQLAlignedRelationTargetNode;
...
export type BCQLRelationMatchNode =
    | BCQLRootRelationMatchNode
    | BCQLRegularRelationMatchNode
    | BCQLAlignedRelationMatchNode;
...
export type BCQLValueNode =
    | BCQLStringValueNode
    | BCQLBooleanValueNode
    | BCQLIntegerValueNode
    | BCQLIntRangeValueNode
    | BCQLSymbolValueNode
    | BCQLUndefinedValueNode;

export type BCQLTagAttributeExpressionNode =
    | Exclude<BCQLValueNode, BCQLSymbolValueNode>
    | BCQLFunctionCallNode;

/**
 * Nodes that can appear where Java evaluation calls toMatchFilter().
 */
export type BCQLConstraintNode =
    | BCQLAndNode
    | BCQLCompareNode
    | BCQLFunctionCallNode
    | BCQLImplicationNode
...
export type BCQLTextPatternNode =
    | BCQLQueryNode
    | BCQLConstraintNode;

export type BCQLTextPatternStruct =
    | BCQLTextPatternNode
    | BCQLRelationTargetNode;