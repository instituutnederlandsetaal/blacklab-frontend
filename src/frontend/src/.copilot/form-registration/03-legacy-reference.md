...
- The new `pages/search/form/filters/lib/filterValueFunctions.ts` already preserves this idea and should be promoted, not discarded.
...
- `src/frontend/src/app/routes/urls/url-state-parser-search.ts` (commented migration copy)
- `src/old-frontend/features/history/model/query-history-state.ts`
