...
/** Standard DOM attributes and Bootstrap classes derived from field presentation props. */
	...
	return computed(() => {
		...
		return {
			...
			rootAttrs: {
				id: props.htmlId,
				title: props.title,
				class: [options.formGroup !== false && formGroupClass, 'blf-field', options.rootClass, props.class, variants],
			},
			formGroupClass,
