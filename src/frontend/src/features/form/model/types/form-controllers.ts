 ...
 */
export type FieldController<Kind extends string = string, State = any, Config extends FieldControllerConfig = FieldControllerConfig> = {
	// Unique key for this controller, used in the form shape definition to bind it to a node/field.
	kind: Kind;
	// Which vue component
	component: Component<{ node: FormFieldNode<Config>; state: State }>;
