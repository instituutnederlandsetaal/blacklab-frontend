---
description: Manual installation instructions for Corpus Frontend
order: 1
---
...
4. **Access the Application**
   - Navigate to `http://localhost:8080/corpus-frontend/` and you should be presented with a set of available corpora in BlackLab.
