...
Where fields are located in the UI is dependent on the [metadataFieldGroups](./06_filters.md#organize-filters-in-tabs) and [annotationGroups](./02_extended_search.md#group-annotations-in-tabs). 
