...
- Allow customizing how a document's title is rendered; see [readme](README.md#customjs-configure-document-title)
- Add ability to insert section titles in between filters. See [readme](README.md#customjs-configure-metadata-subheadings)
- Add ability to disable export buttons. See [readme](README.md#customjs-toggle-export)
- Add ability to customize the error message when no results could be found. See [readme](README.md#customjs-configure-error-message)
